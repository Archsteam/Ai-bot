...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6615626505:AAHGj5i0N1t29ab1sggldVeiGNiPV5wEsLY") 
...
async def chatbotofd(client, message):
    ...
    if not is_Logic:
        ...
        await message.reply_text("CHAT-AI Disabled!")
    if is_Logic:
        await message.reply_text(f"CHAT-AI Is Already Disabled")
...
async def chatboton(client, message):
    ...
    is_Logic = Logic.find_one({"chat_id": message.chat.id})
    if not is_Logic:           
        await message.reply_text(f"CHAT-AI Is Already Enabled")
    if is_Logic:
        Logic.delete_one({"chat_id": message.chat.id})
        await message.reply_text(f"CHAT-AI Is Enabled!")
